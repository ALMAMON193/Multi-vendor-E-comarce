      ...
      <div class="card">
          <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-3"> <input class="form-control form-control-sm" style="width: 100%;" type="text" id="searchInput" placeholder="Search..."></div>
              ...
              <div class="table-responsive">
                  <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                     ...
                     @foreach ($brands as $brand)
                         <tr>
                             <td><img src="{{ asset('public/uploads/brand/'.$brand->image) }}" width="100px" height="100px"></td>
