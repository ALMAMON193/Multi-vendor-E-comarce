                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-end">
                        <div class="lng_dropdown">
                            <select name="countries" class="custome_select">
                                <option value='en' data-image="front-end/assets/images/eng.png" data-title="English">English</option>
                                <option value='fn' data-image="front-end/assets/images/fn.png" data-title="France">France</option>
                                <option value='us' data-image="front-end/assets/images/us.png" data-title="United States">United States</option>
                            </select>
                        </div>
                        <div class="ms-3">
                            <select name="countries" class="custome_select">
    	...
    	<div class="container">
            <div class="nav_block">
                <a class="navbar-brand" href="index.html">
                    <img class="logo_light" src="front-end/assets/images/logo_light.png" alt="logo">
                    <img class="logo_dark" src="front-end/assets/images/logo_dark.png" alt="logo">
                </a>
                        ...
                        <div class="cart_box cart_right dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    ...
                                    <a href="#"><img src="front-end/assets/images/cart_thamb1.jpg" alt="cart_thumb1">Variable product 001</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span>
                                </li>
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="front-end/assets/images/cart_thamb2.jpg" alt="cart_thumb2">Ornare sed consequat</a>
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="front-end/assets/images/menu_banner7.jpg" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="front-end/assets/images/menu_banner8.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Top Laptops</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="front-end/assets/images/menu_banner6.jpg" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="front-end/assets/images/menu_banner9.jpg" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="{{ asset('front-end/assets/images/shop_banner4.jpg') }}" alt="shop_banner2"/>
                                                            </div> 
