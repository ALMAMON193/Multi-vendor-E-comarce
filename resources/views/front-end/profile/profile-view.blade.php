                                ...
                                <form method="POST" action="{{ route('user.profile.update', ['id' => $user->id]) }}" enctype="multipart/form-data">
                                  ...
                                  <div class="row">
                                      <div class="form-group col-md-12 mb-3">
                                          ...
                                          <input required="" class="form-control" name="name" value="{{ $user->name }}" type="text">
                                      </div>
                                      <div class="form-group col-md-12 mb-3">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="controls">
                                              ...
                                              @if (!empty($user->image))
                                                  <img id="showImage" src="{{ asset('upload/user_images/' . $user->image) }}" alt="Profile Image" style="max-width: 100px; max-height: 100px; margin-top: 10px;">
                                              @else
