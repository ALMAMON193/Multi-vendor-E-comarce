...
<link rel="stylesheet" href="{{ asset('front-end/assets/bootstrap/css/bootstrap.min.css') }}">
<!-- Google Font -->
...
<link rel="stylesheet" href="{{ asset('front-end/assets/css/simple-line-icons.css') }}">
<!--- owl carousel CSS-->
<link rel="stylesheet" href="{{ asset('front-end/assets/owlcarousel/css/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ asset('front-end/assets/owlcarousel/css/owl.theme.css') }}">
<link rel="stylesheet" href="{{ asset('front-end/assets/owlcarousel/css/owl.theme.default.min.css') }}">
<!-- Magnific Popup CSS -->
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-sm-5">
                    	<div class="background_bg h-100" data-img-src="front-end/assets/images/popup_img3.jpg"></div>
                    </div>
                </div>
            </div>
    	</div>
...
<script src="{{ asset('front-end/assets/bootstrap/js/bootstrap.min.js') }}"></script> 
<!-- owl-carousel min js  --> 
<script src="{{ asset('front-end/assets/owlcarousel/js/owl.carousel.min.js') }}"></script> 
<!-- magnific-popup min js  --> 
<script src="{{ asset('front-end/assets/js/magnific-popup.min.js') }}"></script> 
<!-- waypoints min js  --> 
<script src="{{ asset('front-end/assets/js/waypoints.min.js') }}"></script> 
<!-- parallax js  --> 
<script src="{{ asset('front-end/assets/js/parallax.js') }}"></script> 
<!-- countdown js  --> 
...
<!-- scripts js --> 
<script src="front-end/assets/js/scripts.js"></script>
