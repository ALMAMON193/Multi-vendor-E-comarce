...
class ProductController extends Controller
{
    ...
    public function ProductEdit($id){
        ...
        return view('backend.product.edit-product',compact('categories','brands','subcategories','subsubcategories','products','multiImages'));
    }
   ...
   public function ProductUpdateMultiImage(Request $request) 
   {
       foreach ($request->multi_image as $id => $img) {
           if ($img !== null && $img->isValid()) {
               ...
               unlink(public_path($imgDel->product_image));
